        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    login_process_id = table.Column<Guid>(type: "uuid", nullable: false),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_login_o_auth_process_login_process_id",
                        column: x => x.login_process_id,
                        principalSchema: "identity",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_login_login_process_id",
                schema: "identity",
                table: "login",
                column: "login_process_id",
                unique: true);
